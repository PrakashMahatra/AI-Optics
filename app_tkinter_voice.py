...
class WebcamQAApp:
    ...
    def capture_thread(self, mode):
        ...
        if mode == "photo":
            ...
            duration = 5 # seconds
            num_frames = 6 # 10 frames for 10 seconds
        ...
        if self.frames:
            ...
            for i, frame in enumerate(self.frames):
                ...
                try:
                    # Generate caption
                    caption = self.get_image_caption(pil_image)
    ...
    def get_image_caption(self, image):
        """Use Ollama to generate a caption for an image"""
    ...
    def answer_question(self, captions, question):
        """Use Ollama to answer a question based on image captions"""
